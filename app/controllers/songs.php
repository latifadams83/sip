...
class Songs extends Controller
{
    ...
    public function addSong()
    {
        ...
        $post_array = $_POST["submit_add_song"];
    }
    ...
    public function deleteSong($song_id)
    {
        ...
        if (isset($song_id)) {
            ...
            $this->model('song')->deleteSong($song_id);
        }
    ...
    public function editSong($song_id)
    {
        ...
        if (isset($song_id)) {
            ...
            $song = $this->model('song')->getSong($song_id);
    ...
    public function updateSong()
    {
        ...
        if (isset($_POST["submit_update_song"])) {
            ...
            $this->model('song')->updateSong($_POST["artist"], $_POST["track"],  $_POST["link"], $_POST['song_id']);
        }
    ...
    {
        $amount_of_songs = $this->model('song')->getAmountOfSongs();
